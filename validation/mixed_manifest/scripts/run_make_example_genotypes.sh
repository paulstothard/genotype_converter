...
Usage:
  validation/mixed_manifest/scripts/run_make_example_genotypes.sh [options]
...
conda run -n "${ENV_NAME}" python validation/mixed_manifest/scripts/make_example_genotypes.py
